...
export async function getFootballFieldBookingById(id: string): Promise<FootballFieldBooking | null> {
  try {
    const result = await db
      .select()
      .from(footballFieldBookings)
...
export async function createFootballFieldBooking(bookingData: FootballFieldBookingInsert): Promise<FootballFieldBooking> {
  try {
    const newBooking = {
      ...bookingData,
...
export async function updateFootballFieldBooking(id: string, updateData: Partial<FootballFieldBookingInsert>): Promise<FootballFieldBooking | null> {
  try {
    const result = await db
