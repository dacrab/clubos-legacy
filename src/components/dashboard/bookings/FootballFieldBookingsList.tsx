...
import { cn, formatDateStringWithGreekAmPm } from '@/lib/utils';
    ...
    <>
      <div className="mb-2 flex items-start justify-between gap-4">
        <div className="flex-1 space-y-1">
          <h3 className="text-foreground font-medium">{booking.whoBooked}</h3>
            ...
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  ...
                  {bookingDate
                    ? format(bookingDate, DATE_FORMAT.DISPLAY, { locale: el })
                    : 'Επιλέξτε ημερομηνία'}
                </Button>
              </PopoverTrigger>
